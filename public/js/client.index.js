...
var app = new Vue({
    ...
    methods: {
        ...
        getClients: function getClients() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients',
        ...
        addClient: function addClient() {
            ...
            $.ajax({
                ...
                toastr.success('创建成功');
                __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?client_id=' + response.data.id);
            });
        },

        customize: function customize() {},

        redirectClientDetail: function redirectClientDetail(clientId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?client_id=' + clientId);
        },

        changCompany: function changCompany(value) {
            console.log(value);
        },
