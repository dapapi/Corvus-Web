...
/***/ "./resources/assets/js/project.index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        starsArr: [],
        projectName: '',
        projectTypeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].projectTypeArr,
        projectFieldsArr: [],
        projectType: '',
        projectFields: '',
        projectsInfo: '',
        ...
        addInfoArr: {},
        levelArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].levelArr,
        visibleRangeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].visibleRangeArr
    ...
    methods: {
        ...
        getProjects: function getProjects() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/projects',
        ...
        projectPrincipalChange: function projectPrincipalChange(e) {
            console.log(e);
        },
        ...
        changeLinkageCompany: function changeLinkageCompany(value) {
            console.log(value);
        },

        changeTargetArtist: function changeTargetArtist(value) {
            console.log(value);
        },

        redirectProjectDetail: function redirectProjectDetail(projectId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?project_id=' + projectId);
        },

        changeProjectType: function changeProjectType(value) {
            app.projectType = value;
        },

        selectProjectType: function selectProjectType() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/project_fields',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: {
                ...
                for (var i = 0; i < response.data.length; i++) {
                    if (response.data[i].field_type === 2) {
                        ...
                        for (var j = 0; j < response.data[i].content.length; j++) {
        ...
        addInfo: function addInfo(value, name) {
...
module.exports = __webpack_require__("./resources/assets/js/project.index.js");
