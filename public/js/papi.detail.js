...
/***/ "./resources/assets/js/papi.detail.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    methods: {
        getArtist: function getArtist() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/bloggers/' + this.artistId,
        ...
        changeWorkAd: function changeWorkAd() {},
...
module.exports = __webpack_require__("./resources/assets/js/papi.detail.js");
