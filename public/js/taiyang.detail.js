...
/***/ "./resources/assets/js/taiyang.detail.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        artistWorkName: '',
        workReleaseTime: '',
        workTypeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].workTypeArr,
        workType: '',
        character: '',
        coActor: '',
        isEdit: '',
    ...
    methods: {
        getArtist: function getArtist() {
            this.artistId = __WEBPACK_IMPORTED_MODULE_1__tool__["default"].getParameterByName('artist_id');
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars/' + this.artistId,
        ...
        getArtistProjects: function getArtistProjects() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars/' + this.artistId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
        ...
        getArtistTasks: function getArtistTasks() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars/' + this.artistId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
        ...
        getArtistWorks: function getArtistWorks() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars/' + this.artistId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
        ...
        changeWorkReleaseTime: function changeWorkReleaseTime(value) {
            app.workReleaseTime = value;
        },

        changeWorkType: function changeWorkType(value) {
            app.workType = value;
        },
        ...
        changeArtistBaseInfo: function changeArtistBaseInfo() {},

        changArtistName: function changArtistName(value) {
            app.artistInfo.name = value;
        },

        changeArtistGender: function changeArtistGender(value) {
            app.artistInfo.gender = value;
        },

        changeArtistDesc: function changeArtistDesc(value) {
            app.artistInfo.desc = value;
        },

        changeArtistSource: function changeArtistSource(value) {
            app.artistInfo.source = value;
        },

        changeArtistCommunication: function changeArtistCommunication(value) {
            app.artistInfo.communication_status = value;
        },

        changeArtistIntention: function changeArtistIntention(value) {
            app.artistInfo.intention = value;
        },

        changeArtistSignStatus: function changeArtistSignStatus(value) {
            app.artistInfo.sign_contract_other = value;
        },

        changeArtistPhone: function changeArtistPhone(value) {
            app.artistInfo.phone = value;
        },

        changeArtistWeixin: function changeArtistWeixin(value) {
            app.artistInfo.wechat = value;
        },

        changeArtistEmail: function changeArtistEmail(value) {
...
module.exports = __webpack_require__("./resources/assets/js/taiyang.detail.js");
