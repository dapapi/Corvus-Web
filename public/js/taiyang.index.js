...
/***/ "./resources/assets/js/taiyang.index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        current_page: 1,
        total_pages: 1,
        genderArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].genderArr,
        artistSourceArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].artistSourceArr,
        customizeInfo: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].customizeInfo,
        projectStatus: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].projectStatus,
        yesOrNoArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].yesOrNoArr,
        artistStatusArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].artistStatusArr,
        taiyangCommunicationStatusArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].taiyangCommunicationStatusArr,
        attachmentTypeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].attachmentTypeArr,
        artistEmail: '',
        artistPhone: '',
        artistWeiXin: '',
        artistsInfo: '',
    ...
    methods: {
        getArtists: function getArtists() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars',
        ...
        changeArtistStatus: function changeArtistStatus(value) {
        ...
        changeCommunicationType: function changeCommunicationType(value) {
            app.communicationStatus = value;
        },

        changeSignIntention: function changeSignIntention(value) {
            app.signIntention = parseInt(value);
        },

        isSignCompany: function isSignCompany(value) {
        ...
        changeBirthday: function changeBirthday(value) {
        ...
        addArtist: function addArtist() {
            ...
            $.ajax({
                ...
                __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('taiyang/detail?artist_id=' + response.data.id);
            });
        },

        changeAttachmentType: function changeAttachmentType(value) {},

        redirectArtistDetail: function redirectArtistDetail(artistId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('taiyang/detail?artist_id=' + artistId);
        },

        selectArtists: function selectArtists(value) {
            if (value === 'all') {
                app.selectedArtistsArr = [];
                for (var i = 0; i < app.artistsInfo.length; i++) {
                    app.selectedArtistsArr.push(app.artistsInfo[i].id);
                }
            } else {
                var index = app.selectedArtistsArr.indexOf(value);
                if (index > -1) {
...
module.exports = __webpack_require__("./resources/assets/js/taiyang.index.js");
