...
/***/ "./resources/assets/js/papi.index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        papiCommunicationStatusArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].papiCommunicationStatusArr,
        artistsInfo: '',
        artistStatus: '',
        artistName: '',
        weiboUrl: '',
    ...
    methods: {
        getArtists: function getArtists() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/bloggers',
        ...
        changeWeiboFansNum: function changeWeiboFansNum(value) {
            app.weiboFansNum = value;
        },

        changeDouyinFansNum: function changeDouyinFansNum(value) {
            app.douyinFansNum = value;
        },

        changeXHSFansNum: function changeXHSFansNum(value) {
        ...
        addArtist: function addArtist() {
            ...
            $.ajax({
                ...
                __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('papi/detail?artist_id=' + response.data.id);
            });
        },
        ...
        changeArtistType: function changeArtistType(value) {
            console.log(value);
        },

        redirectArtistDetail: function redirectArtistDetail(artistId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('papi/detail?artist_id=' + artistId);
        }
    }
});
...
module.exports = __webpack_require__("./resources/assets/js/papi.index.js");
