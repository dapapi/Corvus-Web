...
/***/ "./resources/assets/js/task.detail.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        customizeInfo: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].customizeInfo,
        priorityArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].priorityArr,
        taskStatusArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].taskStatusArr
    },
    ...
    watch: {
        'taskInfo.principal_id': function taskInfoPrincipal_id(newValue) {
        ...
        'taskInfo.start_at': function taskInfoStart_at(newValue) {
            app.changeInfo.start_at = newValue;
        },
        'taskInfo.status': function taskInfoStatus(newValue) {
            app.changeInfo.status = newValue;
        },
        'taskInfo.priority': function taskInfoPriority(newValue) {
            app.changeInfo.priority = newValue;
        },
        'taskInfo.desc': function taskInfoDesc(newValue) {
            app.changeInfo.desc = newValue;
        },
        'taskInfo.end_at': function taskInfoEnd_at(newValue) {
    ...
    methods: {
        ...
        getTask: function getTask() {
            this.taskId = __WEBPACK_IMPORTED_MODULE_1__tool__["default"].getParameterByName('task_id');
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + this.taskId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getStatusCode(),
                data: data
            }).done(function (response) {
                if (response.data.affixes) {
                    for (var i = 0; i < response.data.affixes.data.length; i++) {
                        var size = response.data.affixes.data[i].size;
                        response.data.affixes.data[i].size = _this.unitConversion(size);
                    }
                }

                app.taskInfo = response.data;
                for (var _i = 0; _i < response.data.participants.data.length; _i++) {
                    app.flagParticipantsIdArr.push(response.data.participants.data[_i].id);
                }
                var params = {
                    type: 'change',
                    data: response.data.participants.data
                };
                __WEBPACK_IMPORTED_MODULE_3__store_index_js__["a" /* default */].dispatch('changeParticipantsInfo', params);
                params.data = response.data.principal.data;
                __WEBPACK_IMPORTED_MODULE_3__store_index_js__["a" /* default */].dispatch('changePrincipal', params);
            });
        },
        ...
        customize: function customize(value) {
            console.log(value);
        },

        showSelectMember: function showSelectMember(value) {
        ...
        changeTaskStatus: function changeTaskStatus(status) {
            $.ajax({
                type: 'put',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/status',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: {
        ...
        privacyTask: function privacyTask() {
            $.ajax({
                type: 'put',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/privacy',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: {
                    400: function _(response) {
                        toastr.error(response.responseJSON.message);
        ...
        deleteTask: function deleteTask() {
            $.ajax({
                type: 'delete',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: {
                    400: function _(response) {
                        toastr.error(response.responseJSON.message);
                ...
                __WEBPACK_IMPORTED_MODULE_2__bootstrap___default()('index');
            });
        },

        unitConversion: function unitConversion(size) {
            if (size < 1024) {
                size = size + "B";
        ...
        changeTaskBaseInfo: function changeTaskBaseInfo() {
            var _this = this;
            if (app.changeInfo) {
                $.ajax({
                    type: 'put',
            ...
            if (app.changeParticipantInfo) {
                var changeInfo = app.changeParticipantInfo;
                var participant_ids = [];
                for (var i = 0; i < changeInfo.length; i++) {
                    participant_ids.push(changeInfo[i].id);
                }

                var flagInfo = app.flagParticipantsIdArr;
                var del_participant_ids = [];
                for (var j = 0; j < flagInfo.length; j++) {
                    if (changeInfo.map(function (item) {
                        return item.id;
                    }).indexOf(flagInfo[j]) === -1) {
                ...
                $.ajax({
                    type: 'post',
                    url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/participant',
                    headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                    statusCode: {
                        400: function _(response) {
                            toastr.error(response.responseJSON.message);
        ...
        changeTaskIntroduce: function changeTaskIntroduce(value) {
        ...
        changeTaskStartTime: function changeTaskStartTime(value) {
            app.taskInfo.start_at = value;
        },

        changeTaskPrincipal: function changeTaskPrincipal() {
            app.taskInfo.principal_id = this.$store.state.principalInfo.id;
        },

        uploadAttachment: function uploadAttachment(url, name, size) {
            var _this = this;
            $.ajax({
                type: 'post',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/affix',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: {
                    400: function _(response) {
        ...
        deleteAttachment: function deleteAttachment(attachmentId) {
            $.ajax({
                type: 'delete',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/affixes/' + attachmentId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                statusCode: {
                    400: function _(response) {
                        toastr.error(response.responseJSON.message);
                ...
                toastr.success("删除成功");
                var index = app.taskInfo.affixes.data.indexOf(app.taskInfo.affixes.data.find(function (item) {
        ...
        downloadAttachment: function downloadAttachment(attachmentId, attachmentUrl) {
            window.open(attachmentUrl, '_blank');
            $.ajax({
                type: 'post',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/affixes/' + attachmentId + '/download',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {});
        },

        addChildTask: function addChildTask() {
            var participant_ids = [];
            ...
            $.ajax({
                type: 'post',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/' + app.taskId + '/subtask',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: data
            }).done(function (response) {
                toastr.success('添加成功');
        ...
        addTaskType: function addTaskType(value) {
            app.taskType = value;
        },

        addPrincipal: function addPrincipal(value) {
            app.principal = value;
        },

        addParticipant: function addParticipant(value) {
            var flagArr = [];
        ...
        addTaskLevel: function addTaskLevel(value) {
            app.taskLevel = value;
        },

        addStartTime: function addStartTime(value) {
            app.startTime = value;
        },

        addEndTime: function addEndTime(value) {
            app.endTime = value;
        },

        addLinkage: function addLinkage(value) {},

        addStartMinutes: function addStartMinutes(value) {
            app.startMinutes = value;
        },

        addEndMinutes: function addEndMinutes(value) {
            app.endMinutes = value;
        },
        redirectTaskDetail: function redirectTaskDetail(taskId) {
            __WEBPACK_IMPORTED_MODULE_2__bootstrap___default()('detail?task_id=' + taskId);
        }
...
module.exports = __webpack_require__("./resources/assets/js/task.detail.js");
