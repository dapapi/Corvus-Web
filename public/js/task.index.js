...
var app = new Vue({
    ...
    methods: {
        ...
        getTasks: function getTasks() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/my_all',
        ...
        getMyTasks: function getMyTasks() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/tasks/my',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: data
            }).done(function (response) {
                app.tasksInfo = response.data;
        ...
        addTask: function addTask() {
            ...
            $.ajax({
                ...
                toastr.success('创建成功');
                $('#addTask').modal('hide');
                __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?task_id=' + response.data.id);
            });
        },
        ...
        redirectTaskDetail: function redirectTaskDetail(taskId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?task_id=' + taskId);
        }
    }
