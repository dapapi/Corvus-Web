...
function getMenu() {
    $.ajax({
        url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/modules',
        type: 'get',
                ...
                for (var j = 0; j < apps.length; j++) {
                    ...
                    if (methods.length > 0) {
                        ...
                        for (var k = 0; k < methods.length; k++) {
                            ...
                            methodItem += '<a class="animsition-link" href="/' + module.code + '/' + app.code + '/' + method.code + '">' + '<span class="site-menu-title">' + method.name + '</span>' + '</a>' + '</li>';
...
module.exports = __webpack_require__("./resources/assets/js/left-menu.js");
