...
/***/ "./resources/assets/js/trail.detail.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bootstrap__ = __webpack_require__("./resources/assets/js/bootstrap.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bootstrap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__bootstrap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tool__ = __webpack_require__("./resources/assets/js/tool.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_index__ = __webpack_require__("./resources/assets/store/index.js");
...
var app = new Vue({
    ...
    data: {
        ...
        companyType: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].companyType,
        ...
        endMinutes: '00:00',
        trailTasksInfo: [],
        clientLevelArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].clientLevelArr,
        trailOriginArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].trailOrigin,
        salesProgressText: '未确定合作',
        changeInfo: {},
        selectedExpectationsArr: [],
        selectedRecommendationsArr: [],
        lockArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].lockArr
    },
    ...
    watch: {
        'trailInfo.title': function trailInfoTitle(newValue) {
        ...
        'trailInfo.fee': function trailInfoFee(newValue) {
            app.changeInfo.fee = newValue;
        },
        'trailInfo.brand': function trailInfoBrand(newValue) {
            app.changeInfo.brand = newValue;
        },
        'trailInfo.client.data.company': function trailInfoClientDataCompany(newValue) {
        ...
        'trailInfo.contact.data.name': function trailInfoContactDataName(newValue) {
        ...
        'trailInfo.contact.data.phone': function trailInfoContactDataPhone(newValue) {
            if (app.changeInfo.contact) {
        ...
        'trailInfo.desc': function trailInfoDesc(newValue) {
    ...
    methods: {
        ...
        getTrail: function getTrail() {
            ...
            this.trailId = __WEBPACK_IMPORTED_MODULE_2__tool__["default"].getParameterByName('trail_id');

            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/trails/' + this.trailId,
                ...
                for (var i = 0; i < app.trailInfo.expectations.data.length; i++) {
                    app.selectedExpectationsArr.push(app.trailInfo.expectations.data[i].id);
                }
                for (var _i = 0; _i < app.trailInfo.recommendations.data.length; _i++) {
                    app.selectedRecommendationsArr.push(app.trailInfo.recommendations.data[_i].id);
                }
                if (response.data.principal) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_3__store_index__["a" /* default */].dispatch('changePrincipal', params);
                }
            });
        },
        ...
        getIndustries: function getIndustries() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/industries/all',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {
        ...
        changeTrailOrigin: function changeTrailOrigin(value) {
            this.trailOrigin = value;
        },

        changeTrailBaseInfo: function changeTrailBaseInfo() {
            $.ajax({
                type: 'put',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/trails/' + this.trailId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
        ...
        getStars: function getStars() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/stars/all',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {
                for (var i = 0; i < response.data.length; i++) {
                    app.starsArr.push({
        ...
        getTrailTask: function getTrailTask() {
            if (app.trailTasksInfo.length > 0) {
                return;
            }
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/trails/' + app.trailId + '/tasks',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {
        ...
        redirectCompany: function redirectCompany(companyId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('../client/detail?client_id=' + companyId);
        },

        changeLinkage: function changeLinkage(value) {
            console.log(value);
        },
        ...
        taskPrincipalChange: function taskPrincipalChange(value) {
            app.taskPrincipal.data = value;
        },

        taskParticipantChange: function taskParticipantChange(value) {
            app.taskParticipant.data = value;
        },

        changeTrailName: function changeTrailName(value) {
            app.trailInfo.title = value;
        },

        changeTrailPrincipal: function changeTrailPrincipal(value) {
            console.log(value);
            app.trailInfo.principal.data = value;
        },

        changeTrailFee: function changeTrailFee(value) {
            app.trailInfo.fee = value;
        },

        changeTrailBrand: function changeTrailBrand(value) {
            app.trailInfo.brand = value;
        },

        changeTrailCompany: function changeTrailCompany(value) {
            app.trailInfo.client.data.company = value;
        },

        changeTrailCompanyLevel: function changeTrailCompanyLevel(value) {
            app.trailInfo.client.data.grade = value;
        },

        changeTrailContact: function changeTrailContact(value) {
            app.trailInfo.contact.data.name = value;
        },

        changeTrailContactPhone: function changeTrailContactPhone(value) {
            app.trailInfo.contact.data.phone = value;
        },

        changeTrailExpectations: function changeTrailExpectations(value) {},

        changeTrailRecommend: function changeTrailRecommend(value) {},

        changeTrailDesc: function changeTrailDesc(value) {
            app.trailInfo.desc = value;
        },

        changeExpectations: function changeExpectations(value) {
            console.log(value);
        },

        changeRecommendations: function changeRecommendations(value) {
            console.log(value);
        },

        changePriority: function changePriority(value) {
            console.log(value);
        }
...
module.exports = __webpack_require__("./resources/assets/js/trail.detail.js");
