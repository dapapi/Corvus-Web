...
/***/ "./resources/assets/js/staff.add.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bootstrap__ = __webpack_require__("./resources/assets/js/bootstrap.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bootstrap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__bootstrap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_fetch__ = __webpack_require__("./resources/assets/utils/fetch.js");




var sexArr = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].sexArr,
    maritalStatusArr = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].maritalStatusArr,
    nationalityArr = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].nationalityArr;
...
var app = new Vue({
	...
	mounted: function mounted() {
		...
		var tempInfoArr = ['education', 'work', 'home', 'train'];
		tempInfoArr.map(function (n) {
			for (var _i = 0; _i < 4; _i++) {
				_this[n].tBody.push(JSON.parse(JSON.stringify(_this[n + 'Info'])));
			}
		});
	},
	...
	methods: {
		// 改变data的值
		changeState: function changeState(name, value) {
			this[name] = value;
		},

		// 表格新增行
		tableAdd: function tableAdd(name) {
		...
		submit: function submit() {
			...
			Object(__WEBPACK_IMPORTED_MODULE_2__utils_fetch__["a" /* default */])('post', '/personnel', params).then(function (result) {
				// 
				alert('添加成功');
			});
		}
...
/***/ "./resources/assets/utils/fetch.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_config__ = __webpack_require__("./resources/assets/js/config.js");




// axios 配置
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.timeout = 10000;
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['Accept'] = 'application/vnd.Corvus.v1+json';
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['Access-Control-Expose-Headers'] = 'Location';
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['Access-Control-Allow-Headers'] = 'Authorization';
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['Authorization'] = 'Bearer ' + __WEBPACK_IMPORTED_MODULE_2__js_config__["a" /* default */].getAccessToken() || '';
...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.baseURL = __WEBPACK_IMPORTED_MODULE_2__js_config__["a" /* default */].apiUrl;
...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.interceptors.response.use(function (res) {
	...
	if (status === 401) {
		__WEBPACK_IMPORTED_MODULE_2__js_config__["a" /* default */].getStatusCode()[401]();
	} else {
		toastr.error(response.data.message);
	}
	return Promise.reject(error);
...
function fetch() {
	...
	return new Promise(function (resolve, reject) {
		__WEBPACK_IMPORTED_MODULE_0_axios___default.a[method](url, params).then(function (response) {
...
module.exports = __webpack_require__("./resources/assets/js/staff.add.js");
