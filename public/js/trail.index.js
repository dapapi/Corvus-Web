...
/***/ "./resources/assets/js/trail.index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = new Vue({
    ...
    data: {
        ...
        trailOrigin: '',
        trailType: '',
        trailTypeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].trailTypeArr,
    ...
    methods: {
        ...
        getSales: function getSales() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/trails',
        ...
        getClients: function getClients() {
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients/all',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {
        ...
        addTrail: function addTrail() {
            ...
            $.ajax({
                ...
                __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?trail_id=' + response.data.id);
            });
        },

        redirectTrailDetail: function redirectTrailDetail(trailId) {
            __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()('detail?trail_id=' + trailId);
        },
        ...
        changeTrailOriginType: function changeTrailOriginType(value) {
        ...
        changePrincipal: function changePrincipal(value) {
            app.trailPrincipal = value;
        },

        changeTargetStars: function changeTargetStars(value) {
            app.targetStars = value;
        },

        changeRecommendStars: function changeRecommendStars(value) {
        ...
        changeIndustry: function changeIndustry(value) {
            app.industry = value;
        },
        ...
        changeTrailType: function changeTrailType(value) {
            app.trailType = value;
        },

        changeTrailStatus: function changeTrailStatus(value) {
            app.trailStatus = value;
        },

        changeCooperationType: function changeCooperationType(value) {
...
module.exports = __webpack_require__("./resources/assets/js/trail.index.js");
