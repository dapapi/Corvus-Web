...
function checkLogin() {
    ...
    if (token) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__bootstrap___default()(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].apiUrl + '/worktile/oauth?callback=' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].moeUrl + '/login');
...
module.exports = __webpack_require__("./resources/assets/js/moe.js");
