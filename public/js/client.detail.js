...
/***/ "./resources/assets/js/client.detail.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index_js__ = __webpack_require__("./resources/assets/store/index.js");
...
var app = new Vue({
    ...
    data: {
        clientId: '',
        changeInfo: {},
        clientTypeArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].clientTypeArr,
        clientLevelArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].clientLevelArr,
        clientScaleArr: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].clientScaleArr,
    ...
    watch: {
        'clientInfo.company': function clientInfoCompany(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
            app.changeInfo.company = newValue;
        },
        'clientInfo.type': function clientInfoType(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
            app.changeInfo.type = newValue;
        },
        'clientInfo.grade': function clientInfoGrade(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
            app.changeInfo.grade = newValue;
        },
        'clientInfo.keyman': function clientInfoKeyman(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
            app.changeInfo.keyman = newValue;
        },
        'clientInfo.size': function clientInfoSize(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
            app.changeInfo.size = newValue;
        },
        'clientInfo.desc': function clientInfoDesc(newValue, oldValue) {
            if (oldValue === undefined) {
                return;
            }
    ...
    methods: {
        ...
        getClient: function getClient() {
            this.clientId = __WEBPACK_IMPORTED_MODULE_1__tool__["default"].getParameterByName('client_id');

            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients/' + this.clientId,
                ...
                __WEBPACK_IMPORTED_MODULE_2__store_index_js__["a" /* default */].dispatch('changePrincipal', params);
            });
        },

        getClientTrail: function getClientTrail() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/trails/search',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: {
                    type: 'clients',
                    id: this.clientId,
        ...
        getClientTask: function getClientTask() {
            if (this.clientTasksInfo.length > 0) {
                return;
            }
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients/' + this.clientId + '/tasks',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: {
                    type: 'clients',
                    id: app.clientId,
        ...
        getClientProject: function getClientProject() {
            ...
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/projects/search',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
                data: {
                    type: 'clients',
                    id: this.clientId,
        ...
        getClientContact: function getClientContact() {
            if (app.clientContactsInfo.length > 0) {
                return;
            }
            $.ajax({
                type: 'get',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients/' + this.clientId + '/contacts',
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders()
            }).done(function (response) {
        ...
        // TODO 地区省市级联动没有做
        changeClientBaseInfo: function changeClientBaseInfo() {
            $.ajax({
                type: 'put',
                url: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].apiUrl + '/clients/' + this.clientId,
                headers: __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].getHeaders(),
        ...
        changeClientType: function changeClientType(value) {
            app.clientInfo.type = value;
        },

        changClientName: function changClientName(value) {
            app.clientInfo.company = value;
        },

        changeClientLevel: function changeClientLevel(value) {
            app.clientInfo.grade = value;
        },

        changeClientDecision: function changeClientDecision(value) {
            app.clientInfo.keyman = value;
        },

        changeClientScale: function changeClientScale(value) {
            app.clientInfo.size = value;
        },

        changeClientDesc: function changeClientDesc(value) {
...
module.exports = __webpack_require__("./resources/assets/js/client.detail.js");
