        ...
        <div class="page-header page-header-bordered">
            ...
            <div class="page-header-actions dropdown show task-dropdown float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right task-dropdown-item" aria-labelledby="taskDropdown"
                    ...
                    <a class="dropdown-item" role="menuitem" @click="changeTaskStatus(3)">分享</a>
                    <a class="dropdown-item" role="menuitem" @click="changeTaskStatus(2)">分配制作人</a>
                    <a class="dropdown-item" role="menuitem" @click="changeTaskStatus(2)">自定义字段</a>
                </div>
            </div>
        </div>
        ...
        <div class="page-content container-fluid">
            ...
            <div class="col-md-12 panel">
                ...
                <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                    ...
                    {{--</li>--}}
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" data-toggle="tab" href="#forum-artist-projects"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-toggle="tab" href="#forum-trail-base"
                           aria-controls="forum-present"
                ...
                <div class="tab-content nav-tabs-animate bg-white col-md-12">
                    <div class="tab-pane animation-fade active pb-20 fixed-button-father" id="forum-artist-projects"
                         role="tabpanel">
...
@section('script')
    ...
    <script src="{{ mix('js/trail.detail.js') }}"></script>
