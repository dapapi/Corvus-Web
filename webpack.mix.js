...
mix.js('resources/assets/js/app.js', 'public/js')
    .js('resources/assets/js/calendar.index.js', 'public/js')
    ...
    .js('resources/assets/js/staff.index.js', 'public/js')
    .js('resources/assets/js/staff.history.js', 'public/js')
    .js('resources/assets/js/staff.add.js', 'public/js')
    .js('resources/assets/js/staff.detail.js', 'public/js')
