<template>
    <div class="modal fade" id="addTrail1" aria-hidden="true" aria-labelledby="addLabelForm"
        ...
        <div class="modal-dialog modal-simple">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="example">
                        ...
                        <div class="col-md-10 float-left pl-0">
                            <!-- <div class="float-left col-md-6 pl-0"> -->
                                 <edit-brand @change="changeCompanyName" :options='[1,2,3]' :isEditSelect='true'></edit-brand>
                            <!-- </div> -->
                            <!-- <div class="float-left col-md-6 pl-0"> -->
                                <!-- <selectors :options="clientLevelArr"  -->
                    ...
                    <div class="example">
                        <div class="col-md-2 text-right float-left require">合作类型</div>
                        <div class="col-md-10 float-left pl-0">
                            <selectors ref='industries' :options="coopArr"
                                       @change="changeIndustry"></selectors>
                        </div>
                    </div>
                    <div class="example">
                    ...
                    <div class="example">
                        <div class="col-md-2 text-right float-left require">目标艺人/博主</div>
                        <div class="col-md-10 float-left pl-0">
                    ...
                    <div class="example">
                        <div class="col-md-2 text-right float-left">推荐艺人/博主</div>
                        <div class="col-md-10 float-left pl-0">
                    ...
                    <div class="example">
                        <div class="col-md-2 text-right float-left require">线索级别</div>
                        <div class="col-md-10 float-left pl-0">
                    ...
                    <div class="example">
                     ...
                     <div class="example">
                        <div class="col-md-2 text-right float-left require">微信号码</div>
                        <div class="col-md-10 float-left pl-0">
                            <input type="text" class="form-control" title="" placeholder="请输入联系电话"
                                   v-model="trailContactPhone" @blur='phoneValidate'>
                        </div>
                     ...
                     <div class="example">
                        <div class="col-md-2 text-right float-left require">其他联系方式</div>
                        <div class="col-md-10 float-left pl-0">
                            <input type="text" class="form-control" title="" placeholder="请输入联系电话"
                                   v-model="trailContactPhone" @blur='phoneValidate'>
                        </div>
                    ...
                    <div class="example">
                        <div class="col-md-2 text-right float-left require">合作预算</div>
                        <div class="col-md-10 float-left pl-0 pr-0">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getIndustries() {
                let _this = this;
                fetch('get', '/data_dictionary/564').then(function (response) {
                    for (let i = 0; i < response.data.length; i++) {
                        _this.coopArr.push({
                            id: response.data[i].id,
                            name: response.data[i].name,
