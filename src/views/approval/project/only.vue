                    ...
                    <div class="page-content tab-content nav-tabs-animate bg-white">
                        <div class="tab-pane animation-fade active" id="forum-project" role="tabpanel">
                            <table class="table table-hover is-indent mb-20"
                                ...
                                <tbody>
                                <tr v-for="project in projectsInfo" :key='project.project_number' style="cursor: pointer;" @click="goDetail(project.form_instance_number)">
    ...
    export default {
        ...
        methods: {
            ...
            getList(params) {
                ...
                fetch('get','/approvals_project/notify?status='+currentStatus+'&keywords='+this.keywords).then((params) => {
