    ...
    <div class="page">
        ...
        <div class="site-action" data-plugin="actionBtn" data-toggle="modal" data-target="#addTask">
            <button type="button"
                ...
                <i class="front-icon iconfont icon-tianjiajiahaowubiankuang animation-scale-up" aria-hidden="true"></i>
                <i class="back-icon iconfont icon-tianjiajiahaowubiankuang animation-scale-up" aria-hidden="true"></i>
            </button>
        </div>
