                ...
                <!--<div class="modal-content">-->
                    ...
                    <!--<div class="modal-body">-->
                        ...
                        <!--<div class="example">-->
                            ...
                            <!--</div>-->
                            <!--<div class="col-md-5 float-left pl-0">-->
                                <!--&lt;!&ndash; <Timepicker ref="startMinutes" :default="startMinutes"-->
                                            <!--@change="changeStartMinutes"></Timepicker> &ndash;&gt;-->
                        ...
                        <!--<div class="example">-->
                            ...
                            <!--</div>-->
                            <!--<div class="col-md-5 float-left pl-0">-->
                                <!--&lt;!&ndash; <Timepicker ref="endMinutes" :default="endMinutes"-->
                                            <!--@change="changeEndMinutes"></Timepicker> &ndash;&gt;-->
