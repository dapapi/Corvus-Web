        ...
        <div class="page-header page-header-bordered">
            ...
            <div v-if="canShow" class="page-header-actions dropdown show task-dropdown float-right" style="z-index:1000;right:50px">
                ...
                <div class="dropdown-menu dropdown-menu-right task-dropdown-item" aria-labelledby="taskDropdown"
                    ...
                    <ImportAndExport :type="'import'" :moduleName="artistsInfo.length&&artistsInfo.find(item=>item.sign_contract_status==2)?'blogger':'signing/blogger'" :power="'blogger'" @importFile="importFile">
                        <a class="dropdown-item" role="menuitem">导入</a>
                    </ImportAndExport>
                    <ImportAndExport :type="'export'" :moduleName="artistsInfo.length&&artistsInfo.find(item=>item.sign_contract_status==2)?'blogger':'signing/blogger'" :power="'blogger'" :params="exportParams">
                ...
                <div  class="dropdown-menu  dropdown-menu-right task-dropdown-item" aria-labelledby="taskDropdown"
                    ...
                    <ImportAndExport :type="'import'" :moduleName="artistsInfo.length&&artistsInfo.find(item=>item.sign_contract_status==2)?'stars':'signing/stars'" :power="'star'" @importFile="importFile">
                        <a class="dropdown-item" role="menuitem">导入</a>
                    </ImportAndExport>
                    <ImportAndExport :type="'export'" :moduleName="artistsInfo.length&&artistsInfo.find(item=>item.sign_contract_status==2)?'stars':'signing/stars'" :power="'star'" :params="exportParams">
                        <a class="dropdown-item" role="menuitem">导出</a>
                    </ImportAndExport>
