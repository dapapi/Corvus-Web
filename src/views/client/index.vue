    ...
    export default {
        ...
        methods: {
            ...
            getClients: function (pageNum = 1) {
                ...
                if (this.clientPrincipalSearch) {
                    params.principal_id = this.clientPrincipalSearch
                }

                if (this.companyName || this.clientLevelSearch || this.clientPrincipalSearch) {
                    url = '/clients/filter'
                }
            ...
            getCompanyByFilter () {
                ...
                fetch('get', '/clients/filter?page=1&include=principal', params).then(response => {
                    this.clientsInfo = response.data
                    this.current_page = response.meta.pagination.current_page;
                    this.total = response.meta.pagination.total;
                    this.total_pages = response.meta.pagination.total_pages;
