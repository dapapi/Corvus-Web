            ...
            <div class="modal-content">
              ...
              <div class="modal-body" >
                ...
                <div class="pearls pearls-xs row" >
                      <div class="pearl col-4" v-for="v in setp.data" :key="v.id" :class="setp.iSactive==v.id?'done':''">
                ...
                <div class="example">
                    ...
                    <div class="col-md-10 float-left pl-0">
                        <Selectors  :placeholder="'请选择任务优先级'"
                                    ></Selectors>
                    </div>
                </div>
                <div class="example">
              ...
              <div class="modal-footer">
                <button class="btn btn-sm btn-white btn-pure" data-dismiss="modal" v-show="iScancel" @click="cancel(setp.iSactive)">取消</button>
