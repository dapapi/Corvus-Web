<template>
    <div class="department-item">
        <div class="name" :style="{paddingLeft: paddingLeft + 'px'}" @click="selectData">
            <i v-show="visible" class="icon md-caret-down" @click.stop="showList"></i>
            <i v-show="!visible" class="icon md-caret-right" @click.stop="showList"></i>
        ...
        <template v-for="(item, index) in data.departments.data">
            <Departments v-show="visible" :data="item" :change="change" :isEdit="isEdit" :left="paddingLeft" :key="index" />
        </template>
    </div>
</template>
