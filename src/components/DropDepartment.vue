<template>
    <div class="department-item">
        ...
        <div class="dropdown-menu dropdown-menu-left" aria-labelledby="departmentDropdown" role="menu" x-placement="bottom-end" style="min-width: calc(100% - 30px)">
...
export default {
    name: 'DropDepartment',
    props: ['data', 'bgColor', 'left', 'isEdit'],
    data () {
        return {
            text: ''
        }
